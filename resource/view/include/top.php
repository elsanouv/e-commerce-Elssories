...
<html lang="en">
	<head>
		...
		<?php
			...
			if($pageName === 'index')
			{
				$pageTitle = ucwords('Store Handmade Accessories');
			}
			else
			{
		...
		<title> Elssories | <?php echo $pageTitle ?> </title>
				...
				<div class="header-top">
					<div class="container">
						<div class="header-left header-dropdowns">
							...
							<div class="header-dropdown">
								<a href="#"><img src="public/assets/images/favicon/ina.png" alt="Indonesia flag">INDONESIA</a>
							</div>
						</div>
					...
					<div class="container">
						<div class="header-left">
							<a href="index.php" class="logo">
								<img style="height: 60px;" src="public/assets/images/favicon/logo.png" alt="Elssories Logo">
							</a>
						</div>
						...
						<div class="header-right">
							...
							<div class="header-contact"><span>Call us now</span>
								<a href="tel:#"><strong>+62 856-9464-7115</strong></a>
							</div>
