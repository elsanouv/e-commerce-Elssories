					...
					if(isset($_POST['discount_amnt']))
					{
						if(@$getDiscount > 0) {
							...
							<div class="alert alert-success alert-dismissible fade show" role="alert">
								<strong>Congratulation!</strong> You have get Rupiah '. @$_SESSION['SSCF_DISCOUNT_AMOUNT'] .' tk discount.
					...
					<form action="" method="post">
						<div class="input-group">
							<select class="form-control" name="shipping_method">
								...
								<option value="10000"> 10Rb J&T </option>
								<option value="10000"> 10Rb JNE</option>
								<option value="8000"> 8Rb TIKI</option>
								<option value="10000"> 10Rb NinjaXpress</option>
								<option value="12000"> 12Rb GrabEkspress</option>
								<option value="12000"> 12Rb GoSend</option>
							</select>
							<div class="input-group-append">
