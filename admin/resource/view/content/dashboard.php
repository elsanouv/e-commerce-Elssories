					...
					<div class="panel">
						<div class="panel-body">
							...
							<div class="text-center" style="padding-bottom: 10px;">
								...
								<h5 class="designation"> RA-1 TEKNIK INFORMATIKA </h5>
							</div>
							...
							<ul class="p-social-link pull-right">
								...
								<li class="active">
									<a href="https://www.linkedin.com/in/elsa-novita-41911727b?trk=contact-info">
										<i class="fa fa-linkedin"></i>
									</a>
								</li>										
								<li class="active">
									<a href="https://www.facebook.com/elsa.novita.12914">
					...
					<div class="panel">
						<div class="panel-body">
							<div style="margin-bottom: 10px;">
								<a class="btn p-follow-btn" href="mailto:elsanovitaca@gmail.com"> 
									<i class="fa fa-envelope"></i> &nbsp; elsanovitaca@gmail.com 
								</a>
							</div>
							<div style="margin-bottom: 10px;">
								<a class="btn p-follow-btn" href="callto:085694647115" style="margin-right: 8px;"> 
									<i class="fa fa-phone"></i> &nbsp; +62 856-9464-7115
								</a>
							</div>
						</div>
					</div>
						...
						<div class="carousel slide auto panel-body" id="c-slide">
							...
							<div class="carousel-inner">
								<div class="item text-center active">
									<h3> ELSSORIES | STORE HANDMADE ACCESSORIES  </h3>
					...
					<div class="panel">
						<div class="panel-body p-states green-box">
							<div class="summary pull-left">
								...
								<span>Softwares and Platforms</span>
								<h5> Microsoft Office | Korean Language </h5>
							</div>
							<div id="expense2" class="chart-bar"></div>
						</div>
					</div>
