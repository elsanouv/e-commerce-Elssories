<?php 
	class Controller
	{
		...
		// Character + Number + Space Checking Function  //
		...
		// Letter + Space Checking Function  //
		...
		// Function to Check Password Field (Alphabets + Numbers + At-The-Rate Sign + #&-.@)  //
